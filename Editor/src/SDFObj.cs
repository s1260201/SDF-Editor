...
namespace SDF.Controll
{
    ...
    public class Sphere : SDFObj
    {
        ...
        public void getValue(Vector3 pos, float s)
        {
            this.pos = pos;
            this.s = s;
        }
    ...
    public class Box : SDFObj
    {
        ...
        public void getValue(Vector3 pos, Vector3 b)
        {
            this.pos = pos;
            this.b = b;
        }
    ...
    public class RoundBox : Box
    {
        ...
        public void getValue(Vector3 pos, Vector3 b, float r)
        {
            this.pos = pos;
            this.b = b;
        }
